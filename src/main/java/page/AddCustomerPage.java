...
public class AddCustomerPage extends BasePage {
	...
	WebElement ADD_CUSTOMER_BUTTON_ON_LISTCUSTOMER_LOCATOR;
	@FindBy(how = How.XPATH, using = "//*[@id=\"foo_filter\"]")
	WebElement SEARCHBAR_ON_LIST_CUSTOMER_PAGE_LOCATOR;
	@FindBy(how = How.XPATH, using = "//*[@id=\"summary\"]")
	WebElement CUSTOMER_SUMMARY_BUTTON_LOCATOR;
	...
	public void enterGroupName(String group) {
		selectFromDropdown(GROUP_FIELD_LOCATOR, group);
	}
	...
	public void enterCPassword(String cpassword) {
		// int randomNum = randomNumGenerator();
		CPASSWORD_FIELD_LOCATOR.sendKeys(cpassword);
	}
